...
var ENN_SCHEDULE = [
  ...
  { key: 'MON', idx: 1, ep: 'Morning Bulletin', tm: '10:31–10:41 AM PST',
    links: [
      { label: 'Monday Episode', url: 'https://www.youtube.com/watch?v=vJMKdvk2_HU' },
      { label: '', url: '' },
      { label: '', url: '' },
      { label: '', url: '' },
    ],
  ...
  { key: 'TUE', idx: 2, ep: 'Morning Bulletin', tm: '10:31–10:41 AM PST',
    links: [
      { label: 'Tuesday Episode', url: 'https://youtu.be/pRlwVX-rxzY' },
      { label: '', url: '' },
      { label: '', url: '' },
      { label: '', url: '' },
    ],
  ...
  { key: 'WED', idx: 3, ep: 'Morning Bulletin', tm: '10:31–10:41 AM PST',
    links: [
      { label: 'Wednesday Episode', url: 'https://youtu.be/byd84yEeXtw?si=EYLuU0PuZ2pJ3_j1' },
      { label: '', url: '' },
      { label: '', url: '' },
      { label: '', url: '' },
    ],
  ...
  { key: 'THU', idx: 4, ep: 'Morning Bulletin', tm: '10:31–10:41 AM PST',
    links: [
      { label: 'Thursday Episode', url: 'https://youtu.be/9QDmaGX6ul4?si=DeNXOQ30f9Ue9f4G' },
      { label: '', url: '' },
      { label: '', url: '' },
      { label: '', url: '' },
    ],
